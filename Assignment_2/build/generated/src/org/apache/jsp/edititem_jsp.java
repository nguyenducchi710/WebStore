...
public final class edititem_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\" name=\"productname\" id=\"productname\"/><br>\n");
      out.write("\n");
      out.write("        <label for=\"description\">Description:</label>\n");
      out.write("        <input type=\"text\" value=\"");
      out.print( p.getDesciption());
      out.write("\" name=\"description\" id=\"description\"/><br>\n");
      out.write("\n");
      out.write("        <label for=\"price\">Price:</label>\n");
      out.write("        <input type=\"number\" value=\"");
      out.print( p.getPrice() );
      out.write("\" name=\"price\" id=\"price\"/><br>\n");
      out.write("\n");
      out.write("        <label for=\"gender\">Gender:</label>\n");
      out.write("        <input type=\"text\" value=\"");
      out.print( p.getGender() );
      out.write("\" name=\"gender\" id=\"gender\"/><br>\n");
      out.write("\n");
      out.write("        <label for=\"type\">Type:</label>\n");
      out.write("        <input type=\"text\" value=\"");
      out.print( p.getType() );
      out.write("\" name=\"type\" id=\"type\"/><br>\n");
      out.write("\n");
      out.write("        <label for=\"size\">Size:</label>\n");
      out.write("        <input type=\"text\" value=\"");
      out.print( p.getSize() );
      out.write("\" name=\"size\" id=\"size\"/><br>\n");
      out.write("\n");
